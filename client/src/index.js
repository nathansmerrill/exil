...
// function loadSkybox() {
//     let textures = [];
//     let texture_bt = new THREE.TextureLoader().load('assets/textures/skybox_bt.png');
//     let texture_sd = new THREE.TextureLoader().load('assets/textures/skybox_sd.png');
//     let texture_tp = new THREE.TextureLoader().load('assets/textures/skybox_tp.png');
//
